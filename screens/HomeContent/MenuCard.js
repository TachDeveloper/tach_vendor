...
const MenuCard = ({
  ...
  const handleReject = (isRejected) => {
    ...
    if (isRejected) {
      axios
        .get(
          `https://tach21.in/tachapis/vendor-api/get-orders.php?item_id=${id}&reject_item`
        )
        .then((response) => {
  ...
  const handleAccept = (isAccept) => {
    ...
    if (isAccept) {
      axios
        .get(
          `https://tach21.in/tachapis/vendor-api/get-orders.php?item_id=${id}&accept_item`
        )
        .then((response) => {
          // console.log(response.data);
          onPickup(isAccept);
  ...
  const handlePickup = (isPickup) => {
    ...
    if (isPickup) {
      axios
        .get(
          `https://tach21.in/tachapis/vendor-api/get-orders.php?item_id=${id}&ready_to_pickup`
        )
        .then((response) => {
          // console.log(response.data);
          onPickup(isPickup);
