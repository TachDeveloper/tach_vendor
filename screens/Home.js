...
const Home = ({ route }) => {
  ...
  const fetchOrders = async () => {
    ...
    axios
      .get(
        `https://tach21.in/tachapis/vendor-api/get-orders.php?vendor_id=${vendorId}&new_orders_with_items`
      )
      .then((response) => {
...
function getTotalSales() {
    axios
      .get(
        `https://tach21.in/tachapis/vendor-api/get-orders.php?vendorid=${vendorId}&fetch_total`
      )
      .then((response) => {
  ...
  function getTodaySales() {
    axios
      .get(
        `https://tach21.in/tachapis/vendor-api/get-orders.php?vendorid=${vendorId}&todays_date=${date.replaceAll(
          "/",
          "-"
        )}&fetch_todays`
      )
