...
const LoginWithOtp = ({ navigation }) => {
  ...
  const verifyNumber = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        `https://tach21.in/tachapis/vendor-api/login-with-mobile.php?mobile=${number}&check`
      );
  ...
  const verifyOtp = () => {
    ...
    axios
      .get(
        `https://tach21.in/tachapis/vendor-api/login-with-mobile.php?mobile=${number}&otp=${otpInput}&check`
      )
      .then((response) => {
